  ...
  return (
    <section className="success-booking-page">
      <div className="container-fluid text-center">
        ...
        <p className="message">
          Thank you for choosing to book tickets with HulyaX! Your reservation is confirmed. You can view your tickets in your profile page and download it or mail to your email account.
        </p>
